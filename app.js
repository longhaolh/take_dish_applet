...
const uploadTool = require('./route/upload_file')
...
app.use('/verify', user_power).use('/verify', dish_power).use('/verify', category_power).use('/verify', shop_power).use('/verify', uploadTool)
